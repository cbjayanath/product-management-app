                        ...
                        <form action="{{ route('products.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name=" category_id" aria-label="Default select example">
                                    <option selected>Select product category</option> {{-- get category data --}}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="display_order_no" value="{{ old( 'display_order_no' ) }}"
                                    id="display_order_no" class="form-control" />
                                @error('display_order_no')<small class="text-danger">{{ $message }}</small>@enderror
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Price</label>
                                <input type="number" name="price" value="{{ old( 'price' ) }}" id="name"
                                    class="form-control" />
                                @error('price')<small class="text-danger">{{ $message }}</small>@enderror
                            </div>
                            <div class="mb-3">
                                {{-- saving created by field as hidden input --}}
